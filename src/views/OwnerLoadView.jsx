              ...
              <div key={b.id} className="rounded-2xl border border-neutral-800 p-3">
                <div className="flex items-center justify-between gap-3 mb-3">
                  <div className="text-sm text-neutral-200">
                    ...
                    {b.name?.trim() ? <span className="font-semibold">{b.name}</span> : <span className="text-neutral-500">без названия</span>}
                  </div>
                ...
                <div className="grid grid-cols-1 md:grid-cols-12 gap-3">
                  ...
                  <div className="md:col-span-5">
                    ...
                    <TextInput value={b.name} onChange={(v) => updateBoat(b.id, { name: v })} disabled={locked} placeholder="Например: Ласточка" />
                  </div>
              ...
              <div key={s.id} className="rounded-2xl border border-neutral-800 p-3">
                <div className="flex items-center justify-between gap-3 mb-3">
                  <div className="text-sm text-neutral-200">
                    ...
                    {s.name?.trim() ? <span className="font-semibold">{s.name}</span> : <span className="text-neutral-500">без имени</span>}
                  </div>
                ...
                <div className="grid grid-cols-1 md:grid-cols-12 gap-3">
                  <div className="md:col-span-6">
                    ...
                    <TextInput value={s.name} onChange={(v) => updateSeller(s.id, { name: v })} disabled={locked} placeholder="Например: Андрей" />
                  </div>
      ...
      <Section title="Контроль">
        <Card>
          ...
          <div className="mt-3 flex items-center justify-end gap-2">
            ...
            >
              Сохранить (без возможности редактирования)
            </button>
          </div>

          <div className="mt-2 text-xs text-neutral-500">
            Сохранение в этом UI — демонстрация. В реальной логике: запись помечается как “введены вручную”, правка запрещена.
          </div>
        </Card>
      </Section>
    </div>
